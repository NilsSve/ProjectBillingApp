...
<Form action="Customer.asp" method="POST" name="Customer" onsubmit="SetChangedStates(this)">
...
<table border="0" Class="EntryTable">
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Customer_Number",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Name",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Address",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
     <%=oCustomer.DDValue("Customer.Status",DDRADIO,"Active|Inactive")%>      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  </tr>
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.City",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
     <%=oCustomer.DDValue("Customer.State",DDCOMBO)%>      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  </tr>
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Zip",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Phone_Number",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Fax_Number",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Email_Address",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Credit_Limit",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Purchases",DDFORM)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
  ...
  <tr>
      ...
      <td Class="Data">
      <%=oCustomer.DDValue("Customer.Comments",DDEDIT,60)%>
      </td>
      <% If FieldError<>"" then %>
      <td Class="Error"><%=FieldError%></td>
      <% end if %>
